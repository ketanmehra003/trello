...
const featureIntroductionList = [
  ...
  },
  {
    ...
    tagsTitle: "Share Notes Instantly",
    tagsDescription:
          ...
          <Suspense fallback={<div>Loading feed...</div>}>
            {featureIntroductionList.map((d, index) => (
              <div
                ...
                className="flex w-[32%] items-center gap-2.5 rounded-lg border border-solid border-gray-100_01 bg-white-A700 px-4 py-[22px] md:w-ful sm:py-5"
                >
                <Img
                src={d.tagsImage}
                width={76}
...
<div className="flex flex-1 flex-col items-start">
  <Heading as="h6">{d.tagsTitle}</Heading>
